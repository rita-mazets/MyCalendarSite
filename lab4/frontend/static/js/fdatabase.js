import {set, ref, get, child, onValue} from "https://www.gstatic.com/firebasejs/9.8.0/firebase-database.js"
...
export const getAssesmentInfo = async (weekId) => {
    ...
    get(child(userRef, `discription/${user.uid}/${weekId}`)).then((snapshot) => {
        if (snapshot.exists()) {
